...
const CSVUploader = () => {
  ...
  return (
    <div>
      ...
      <button disabled={!file} className="btn" style={{ marginBottom: 50, fontFamily: "monty", fontSize: '1rem', background: 'linear-gradient(90deg,#025401,#14ff00)', color: 'white', border: 'none', borderRadius: 999, padding: '12px 22px', marginLeft: 8, marginTop: 150 }}>
        Analyse
      </button>
    </div>
  );
